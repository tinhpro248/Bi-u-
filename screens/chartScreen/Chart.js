    ...
    <View
      style={{
        ...
        borderRadius: 20,
          ...
          width={0.75*WIDTH}
          hideDataPoints
          spacing={((0.75*WIDTH+30)/(ptData.length))}
          color="#16CFDB"
          thickness={2}
      ...
      <TouchableOpacity
        ...
        style={{width: 80,
          ...
          activeOpacity={1}
        >
          <Text style={{color:'white', fontWeight: 'bold', fontSize: 15}}>1 ngày</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        style={{width: 80,
          ...
          activeOpacity={1}
        >
          <Text style={{color:'white', fontWeight: 'bold', fontSize: 15}}>1 tuần</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        style={{width: 80,
          ...
          activeOpacity={1}
        >
          <Text style={{color:'white', fontWeight: 'bold', fontSize: 15}}>1 tháng</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        style={{width: 80,
          ...
          activeOpacity={1}
        >
          <Text style={{color:'white', fontWeight: 'bold', fontSize: 15}}>1 năm</Text>
      </TouchableOpacity>
      </View>
      </View>
  );
