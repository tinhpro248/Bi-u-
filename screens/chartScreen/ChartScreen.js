...
import IrrigationHistoryScreen from '../irrigationHistoryScreen/IrrigationHistoryScreen';
...
const Tabb = () => {
  return (
      <Tab.Navigator screenOptions={{swipeEnabled: false, tabBarStyle: styles.tabBar, tabBarPressColor: 'transparent', tabBarIndicatorStyle: styles.tabIndicator, tabBarLabelStyle: styles.tabLabel}}>
        <Tab.Screen name='Thông tin' component={Ifo}/>
        <Tab.Screen name='Biểu đồ' component={Chart}/>
        <Tab.Screen name='Điều khiển' component={Ifo}/>
      </Tab.Navigator>
  );
}
var title = 'Thông tin khu đất'
function Ifo({navigation}) {
  return (
      <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
          <Text>This is Info</Text>
          <Button
      title="Go to Irrigation History"
      onPress={() => {navigation.navigate('wateringHistory');}}
    />
      </View>
  )
}
    ...
    <View style={styles.container}>
      ...
      <View style={styles.listInfo}>
        ...
        <Stack.Navigator screenOptions={{headerShown: false}}>
          ...
          <Stack.Screen name='wateringHistory' component={IrrigationHistoryScreen}/>
        </Stack.Navigator>
      </View>
    </View>
  );
